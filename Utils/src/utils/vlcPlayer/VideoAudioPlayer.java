...
//	}
	...
	public static void main(String[] args) {
		...
		if (test==1) {  // Varios vídeos
			...
			reproduceAudio( "d:/GDrive/d/media/videos/AOrdenar/Musica/AGUA VIVA -- Poetas Andaluces (1974).flv" );
			reproduceAudio( "d:\\GDrive\\d\\media\\videos\\AOrdenar\\Musica\\Ana Torroja - No me canso.mp3" );
